...
- 🏆 **Honors:** Tau Beta Pi Graduate Fellowship, WIAA Grad Outreach Chair, DEIB Committee Member
...
- 💡 Previously, I worked on **Quadcopter Controller Training** at the Multi-Robot Systems Lab (MSL)
...
- **Genetic Algorithm Optimization for Virtual Flight** (Spring 2024)
...
- **Can We Win Blackjack?** (Fall 2023)
  - Implemented Q-learning and SARSA agents for playing Blackjack and created policy visualizations
  - Developed optimal policies through reinforcement learning techniques and hyperparameter tuning

- **Turtlebot Navigation** (Spring 2023)
...
- **Certificates:**
  - FE Mechanical Exam (NCEES Certification)
  - Stanford Ignite (School of Business Executive Education)
